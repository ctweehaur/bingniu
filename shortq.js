...
const shortQData = [
    {
        ...
        qPy: "hé yǐ jiàn dé shī zhōng lǎo niú de zāo yù bēi cǎn sān fēn",
        ...
        aPy: "tā yī shēng láo lèi hào jìn lì qì jīn pí lì jìn dì wéi rén men gēng tián zhòng liáng què dé bù dào rén men de tóng qíng guān xīn lián xī",
    ...
    },
    {
        id: "Q2",
        qZh: "老牛的付出换来什么成果？[4分]",
        qPy: "lǎo niú de fù chū huàn lái shén me chéng guǒ sì fēn",
        ...
        aPy: "bìng niú de xīn qín láo dòng huàn lái le qiān zuò zhuāng mǎn mǐ gǔ de liáng cāng ràng bǎi xìng dōu néng gòu wēn bǎo",
    ...
    },
    {
        ...
        qPy: "shī zhōng de lǎo niú yǒu shén me pǐn zhì zhí dé wǒ men zàn shǎng sān fēn",
        ...
        aPy: "rèn láo rèn yuàn gān xīn fèng xiàn tā bù xī xī shēng zì jǐ yě yào zào fú tā rén",
        aEn: "It is duty-bound without complaint and selflessly devoted (3 marks). It sacrifices itself to benefit others."
    }
];

console.log("成功加载：bingniu_shortq 简答题数据包");
